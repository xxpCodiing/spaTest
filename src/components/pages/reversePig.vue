<template>
       <div class="up ub-ver">     
        <keyboard  :keybordset="keyboardSet"  :editval="curDays" :nextext="editState"
                    v-on:fulldata="fullData"
                    v-on:clear="clear"
                    v-on:nextobj="nextObj"
                    v-on:commit="commit"
        > </keyboard>
              <div class="body_box">
                <div class="Tnav top_bg ub col_w">
                    ...
                    <div class="ub-f1 tx-c ulev-3 ">
                        <span>引种后备</span>
                        <span>总<strong class="ulev1 font_bold">{{yz_total}}</strong>头</span>
                    </div>
                ...
                <div class="piginfo ub ub-ver bg_w">
                    ...
                    <div class="ub ub-f1 entering body_text ubt">
                        <div class="ub-f1 ub ub-ac fontt_one">
                            正在录入第<span class="col_b font_bold">{{editIndex+1}}</span>头
                        </div>
