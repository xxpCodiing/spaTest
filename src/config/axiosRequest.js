 ...
 */
 ...
 //默认get方法
 export default async(url = '', data = {}, type = 'GET'/*,succ,fail*/,extra) => {
    ...
    if(axios){
        ...
        console.log("axios请求链接：" + url);
        if(extra){
            extra.url  = url
            extra.method = type
            extra.headers = requestConfig.headers
            requestConfig = extra
        }
        ...
        try {
			/*await axios(requestConfig).then(function(response){
